...
window.SteelAssaultLevels=[
 {id:1,name:'Штурм аванпоста',description:'Высадка у передового вражеского поста. Пройди лесной рубеж, подави охрану и уничтожь сторожевую платформу.',mode:'horizontal',theme:'jungle',scene:'frontier_outpost',length:4000,difficulty:.62,boss:'Сторожевая платформа',bossType:'fortress',hazards:'none',pickups:['V','F']},
 {id:2,name:'Речной перевал',description:'Пробейся через разрушенную переправу над быстрой рекой. Прыгай через разрывы моста и удержи плацдарм.',mode:'horizontal',theme:'port',scene:'river_pass',length:4450,difficulty:.72,boss:'Амфибия-12',bossType:'walker',hazards:'pits',pickups:['V','F','B']},
